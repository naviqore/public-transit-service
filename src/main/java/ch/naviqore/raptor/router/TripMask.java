 ...
 *
 * @param earliestTripTime the earliest trip time for the route (in seconds relative to the mask date) (used to skip
 *                         service days quickly while scanning)
 * @param latestTripTime   the latest trip time for the route (in seconds relative to the mask date) (used to skip
 *                         service days quickly while scanning)
 */
